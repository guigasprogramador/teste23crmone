...
interface DocumentosRepositorioSelectorProps {
...
export function DocumentosRepositorioSelector({ 
  onDocumentosSelecionados, 
  documentosSelecionadosIniciais = [] 
}: DocumentosRepositorioSelectorProps) {
  ...
  }, [documentosSelecionados, documentos]) // Removida dependência onDocumentosSelecionados para evitar loop
  ...
  return (
    <Card className="border-2 border-blue-100 mb-4 shadow-sm">
      ...
      <CardContent className="p-3">
        <p className="text-sm text-muted-foreground mb-2">
          Selecione documentos existentes com tag "licitação" para vincular:
        </p>
